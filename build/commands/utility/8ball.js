...
var EightBall = (function () {
    function EightBall() {
        this.title = '8Ball';
        this.description = 'Me faça uma pergunta e deixe-me fazer uma previsão';
        this.args = 'pergunta';
        this.aliases = ['8ball'];
    }
    EightBall.prototype.run = function (client, message, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, message.channel.send(reply)];
            });
        });
    };
    return EightBall;
