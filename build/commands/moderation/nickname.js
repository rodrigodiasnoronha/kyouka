...
var Nickname = (function () {
    function Nickname() {
        this.title = 'Nickname';
        this.description = 'Mude o apelido de algum usuário';
        this.aliases = ['nickname', 'nomeusuario'];
        this.args = 'nickname';
    }
    Nickname.prototype.run = function (client, message, args) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var userHasPermission, user, newNickname, member, oldNickname;
            return __generator(this, function (_c) {
                ...
                oldNickname = member === null || member === void 0 ? void 0 : member.user.username;
                try {
                    if (!newNickname) {
                        member === null || member === void 0 ? void 0 : member.setNickname(member.user.username);
                        return [2, message.channel.send("\n                :white_check_mark: Apelido de " + user.username + " redefinido.\n            ")];
                    }
                    member === null || member === void 0 ? void 0 : member.setNickname(newNickname);
                    return [2, errorMessage_1.sendSucessMessage("Nickname mudado com sucesso.", message)];
                }
                catch (err) {
